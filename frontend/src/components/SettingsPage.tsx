...
import { OpenConfigFolder, SelectFolder } from "../../wailsjs/go/main/App";
import { ApiStatusTab } from "./ApiStatusTab";
const TidalIcon = ({ className }: { className?: string }) => (
  <svg
    viewBox="0 0 24 24"
    className={`inline-block w-[1.1em] h-[1.1em] mr-2 ${className || "fill-muted-foreground"}`}
  >
...
export function SettingsPage({
  ...
  const [activeTab, setActiveTab] = useState<"general" | "files" | "api">(
    "general",
  );
  return (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={String(tempSettings.maxRetries ?? 0)}
                  onValueChange={(value) =>
                    setTempSettings((prev) => ({
                      ...prev,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-2 pt-2">
                ...
                <div className="flex gap-2">
                  <Select
                    value={tempSettings.separator}
                    onValueChange={(value: "comma" | "semicolon") =>
                      setTempSettings((prev) => ({
                        ...prev,
                        separator: value,
                      }))
