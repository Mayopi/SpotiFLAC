...
import { Upload, ArrowLeft, Trash2, Download, GitCompareArrows } from "lucide-react";
import { AudioAnalysis } from "@/components/AudioAnalysis";
import { SpectrumVisualization } from "@/components/SpectrumVisualization";
import { AudioComparePage } from "@/components/AudioComparePage";
    ...
    return (<div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <Button variant={compareMode ? "default" : "outline"} size="sm" onClick={() => { setCompareMode(prev => !prev); clearResult(); }}>
                        <GitCompareArrows className="h-4 w-4 mr-1"/>
                        Compare
                    </Button>
                </div>
                {!compareMode && result && (<div className="flex gap-2">
            ...
            {compareMode && <AudioComparePage />}

            {!compareMode && !result && !analyzing && (<div className={`flex flex-col items-center justify-center h-[400px] border-2 border-dashed rounded-lg transition-colors ${isDragging
            ...
            {!compareMode && analyzing && !result && (<div className="flex h-[400px] items-center justify-center">
            ...
            {!compareMode && result && (<div className="space-y-4">
